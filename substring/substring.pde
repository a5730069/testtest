...
/*for(int i =0; i < maxdisplay/space; i++){
  ...
  if(buttoncolor3 == #F01B1B){
    ...
    for (int i = 0; i <maxdisplay/space2; i++ ) {
     ...
     fill(255);
    text("ch1 ="+max(maxlength)*3.3 /4095  +"  V",170,700); 
   text("ch2 ="+max(maxlength2)*3.3 /4095 +"  V",530,700 );
    count = 0;
    count2=0;
     space2 = (((Y[1]-450)/18)+1);
    space = (((Y[0]-450)/18)+1);
...
void GUI() {
  ...
  text("ch2",1095,435 );
  textSize(20);
  text("Channel 1", 1050, 260); 
  
  text("Channel 2", 1050, 330);
  textSize(20);
  text("Stop", 1065, 180);
   textSize(20);
  text("MENU", 1060, 110);
